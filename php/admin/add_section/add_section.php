...
<body>
    ...
    try{
        ...
        $sql = "INSERT INTO p1_section VALUES ('$id','$sec_id',$semester)";
        ...
        echo "<script>alert('There has been some error on this page, please contact administrator!');window.location.replace('../../../html/admin/add_section/');</script>";
    }
    ?>
</body>
