...
<html>
    <body>
        ...
        $section=$_POST['validationCustom05'];
            ...
            if($count == 1){
                echo '<script>alert("Student with this combination already exists");setTimeout(()=>{window.location.replace("../html/add_student.html");},700);</script>';  
            } 
            else {
                ...
                echo '<script>alert("Student successfully added");setTimeout(()=>{window.location.replace("../html/add_student.html");},700);</script>';  
                else
                echo '<script>alert("Some error was detected! Please try again later.");setTimeout(()=>{window.location.replace("../html/add_student.html");},700);</script>';  
