...
try{
    ...
    $sql = "select * from p1_instructor where id = '$username'";
    ...
    if ($count == 1) {
        ...
        echo "<script>
                    alert('OTP has been sent to mail please verify the otp');setTimeout(()=>{window.location.replace('../../html/faculty/verifyotp.php');},1000);
                    </script>";
        exit;
    } else
