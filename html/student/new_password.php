...
<?php
  session_start();
  if (!(isset($_SESSION['email']) && ($_SESSION['verified']==TRUE))) {
    session_unset();
    session_destroy();
    echo "
        <script>
  ...
  <div id="login">
    <div class="newform">
      <form name="f1" action="../../php/student/new_password.php" onsubmit="return validation()" method="post" style="display:grid;width: 350px;" id="FORM">
        <div class="mb-3">
          <input type="password" name="password" class="form-control" id="password" aria-describedby="passwordHelp" placeholder="Enter new password" pattern="\w{8,20}" required>
