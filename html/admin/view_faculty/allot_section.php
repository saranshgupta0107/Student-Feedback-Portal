...
<body>
    ...
    ?>
     <div class="container-fluid fixed-top" style="margin:0;padding:0;">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" style="text-decoration: none;"><a href="../view_faculty/">View Faculty</a></li>
    ...
    <div id="top" class='table-responsive' style="margin-top:200px">
        <form action="../../../php/admin/view_faculty/faculty_section_add.php" method="POST" style="display:grid;width: 100%;margin:1%" id="FORM">
