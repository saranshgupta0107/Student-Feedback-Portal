...
<body>
    ...
    <div id="top" class='table-responsive d-block' style="margin-top:200px">
        <form action="../../../php/admin/view_feedback/delete_feedback.php" method="POST" style="display:grid;width: 100%;" id="FORM">
