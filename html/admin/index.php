  ...
  <div id="group">
    <div class="card-group" style="padding: 10%; background-color: rgba(0, 0, 0, 0.558);">
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">View the feedbacks submitted.</p>
              <a class="btn btn-primary" href="view_feedback.html" role="button">View Feedback</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Add courses to teachers</p>
              <a class="btn btn-primary" href="add_faculty_course.html" role="button">Add courses</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Add any new user to the portal.</p>
              <a class="btn btn-primary" href="add_faculty.html" role="button">Add Faculty</a>
            </div>
          </div>
        </div>
      </div>
      <div class="row mt-4">
        <div class="col">
          <div class="card">
            <img src="https://source.unsplash.com/1400x700/?education" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Add Student</h5>
              <p class="card-text">Add any new user to the portal.</p>
              <a class="btn btn-primary" href="add_student.html" role="button">Add Student</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card">
            <img src="https://source.unsplash.com/1400x700/?school" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">View Faculty</h5>
              <p class="card-text">View Preregistered faculty.</p>
              <a class="btn btn-primary" href="show_faculty.html" role="button">View Faculty</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card">
            <img src="https://source.unsplash.com/1400x700/?student" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Edit student</h5>
              <p class="card-text">Edit courses offered to students</p>
              <a class="btn btn-primary" href="view_student.html" role="button">Edit students</a>
            </div>
          </div>
        </div>
      </div>
